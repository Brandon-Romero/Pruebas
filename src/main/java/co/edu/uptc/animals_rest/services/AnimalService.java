...
public class AnimalService {
    ...
    private final String filePath = "data\\animals.txt";
    ...
    public List<CategoryCount> getAnimalCountByCategory() throws IOException {
        List<String> listAnimal = Files.readAllLines(Paths.get(filePath));
        List<Animal> animales = new ArrayList<>();
        ...
        // Agrupamos por categoría y contamos los animales
        Map<String, Long> categoryCountMap = animales.stream()
            .collect(Collectors.groupingBy(Animal::getCategory, Collectors.counting()));

        // Convertimos el Map a una lista de CategoryCount
